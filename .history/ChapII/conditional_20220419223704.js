...
// let message = "Bạn không được coi phim rạp.";
// if (Number(yourAge) >= 18) {
//    message = "Bạn được coi phim rạp.";
// }
// alert(message);
// 2. Cho hai số a và b, tìm ra số lớn hơn
const a = 10;
const b = 10;
if (a > b) {
    alert(`Số lớn hơn là: ${a}`);
} else if (a < b) {
    alert(`Số lớn hơn là: ${b}`)
} else {
    alert("Không có số nào lớn hơn số nào cả"); 
}

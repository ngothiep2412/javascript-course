...
console.log(animals2); //["tiger", "dolphin", "lion", "dog"]
...
// Trả về true khi thỏa 1 điều kiện và ngược lại trả về false khi không thỏa điều kiện
const someNumber = listNumber.some((value) => value > 0);
console.log(someNumber);
console.log("----array.every----");
// Chỉ trả về true khi tất cả điều kiện đều đúng, ngược lại chỉ cần 1 cái sai là nó sẽ return false
const everyNumber = listNumber.every((value) => value > 3);
console.log(everyNumber);
console.log("----array.reduce----");
// gom các phần tử trong mảng lại thành 1

...
// 2.4 document.getElementsByTagName("tagName") --> trả về một HTMLCollection chứa danh sách các node, nếu không có thì trả về
// empty
const tagNode = document.getElementsByTagName("ul");
console.log(tagNode);
// 2.5 document.getElementByID("id") --> trả về một node không tìm thấy thì trả về null

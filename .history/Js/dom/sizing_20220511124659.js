...
log(boxed.clientWidth); // độ rộng của phần tử - border
log(boxed.clientHeight); // độ dài của phần tử - border
log(boxed.clientLeft); // vị trí bên trái của nó so với bên trái border
log(boxed.clientTop); // vị trí phía trên của nó so với bên trái border

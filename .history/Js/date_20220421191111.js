...
// In ra timestamp
console.log(birthday.geUTCtTime()); //1009126800000
// Các hàm set trong Date
console.log(`My birthday: ${birthday}`);
birthday.setUTCFullYear(2000);
birthday.setUTCMonth(11);
birthday.setUTCDate(30);
birthday.setUTCHours(12);
birthday.setUTCMinutes(12);
birthday.setUTCSeconds(22);
console.log(`My birthday after update: ${birthday}`);
